...
const Projects = () => {
  ...
  const projects = [
    {
      id: 1,
      title: "Pinventory Management System",
      description:
        "A full-stack inventory management system designed to automate warehouse operations. Features include role-based access, real-time inventory tracking, admin dashboards, and secure CRUD operations, reducing manual errors and improving operational efficiency.",
      ...
      liveUrl: "https://pinventory-app-frontend.vercel.app/",
      githubUrl: "https://github.com/prashanthks97",
    },
    {
      id: 2,
      title: "3D Portfolio Website – Interactive & Animated",
      description:
        "An immersive personal portfolio website featuring real-time 3D scenes powered by Spline, smooth entrance and scroll-based animations using GSAP, and a fully responsive UI built with React and Tailwind CSS.",
      image: "/Images/project-2.png",
      tech: ["React", "Tailwind CSS", "GSAP", "Spline", "Vercel"],
      liveUrl: "https://html-po20.vercel.app/",
      githubUrl: "https://github.com/prashanthks97",
    },
    {
      id: 3,
      ...
      description:
        "A clean and modern marketing landing page built with vanilla JavaScript, HTML, and CSS. Focused on responsive design, smooth animations, and performance-optimized layouts to deliver a polished user experience across all devices.",
      image: "/Images/project-3.webp",
      tech: ["HTML", "CSS", "JavaScript"],
      liveUrl: "https://pixselo.com/index.html",
    },
  ];
      ...
      <div className="container mx-auto max-w-7xl">
        <div ref={titleRef} className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            A curated collection of full stack projects demonstrating my
            expertise in building modern, scalable web applications — from
            intuitive frontends to robust backend systems.{" "}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project) => (
            <div
              key={project.id}
              className="glass cursor-pointer rounded-xl overflow-hidden hover:shadow-glow-primary transition-all duration-500 group"
            >
