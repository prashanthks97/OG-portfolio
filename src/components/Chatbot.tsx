  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      ...
      if (userInput.includes("services")) {
        reply = "Prashanth offers services in frontend, backend development, animations, and AI integration. Would you like a portfolio link?";
      } else if (userInput.includes("contact")) {
        reply = "You can contact Prashanth via the contact form above or email him directly at prashanthsomshekar1997@gmail.com";
      } else if (userInput.includes("react") || userInput.includes("gsap")) {
        reply = "Yes! Prashanth uses React, GSAP, and even WebGL to build stunning UIs.";
      } else if (userInput.includes("project")) {
        reply = "Tell me more about your project! Prashanth can help with frontend, backend, UI/UX design, and building full-stack web applications.";
      }
