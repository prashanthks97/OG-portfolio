      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          <div>
            ...
            <div className="flex gap-4">
              <a href="https://github.com/prashanthks97" className="w-10 h-10 bg-gradient-primary rounded-lg flex items-center justify-center hover:shadow-glow-primary transition-all duration-300 hover:scale-110">
                <GithubLogo size={18} className="text-primary-foreground" />
              </a>
              <a href="https://www.linkedin.com/in/prashanth-k-s/" className="w-10 h-10 bg-gradient-secondary rounded-lg flex items-center justify-center hover:shadow-glow-secondary transition-all duration-300 hover:scale-110">
          ...
          <div>
            ...
            <div className="space-y-3">
              <p className="text-muted-foreground">
                ...
                prashanthsomshekar1997@gmail.com
              </p>
              <p className="text-muted-foreground">
        ...
        <div className="border-t border-border/30 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-muted-foreground text-center md:text-left">
            © 2026 Prashanth. All rights reserved.
          </p>
